                ...
                <div class="col-md-12 col-12 col-xl-3 offset-sm-0 footer-icons-wrap mt-5 mt-xl-0">
                    <ul class="footer-icons-list d-sm-flex flex-row flex-xl-row justify-content-center align-items-center">
                        <?php while (have_rows('socials', 'option')) : the_row(); ?>
                            <?php if (get_sub_field('social_link') && get_sub_field('social')): ?>
                                <li class="footer-icon mb-xs-1">
                                    <a class="social-link-icon" href="<?php the_sub_field('social_link') ?>">
                                        <img class="social-icon" src="<?php echo get_template_directory_uri() ?>/img/social-icons/<?php the_sub_field('social'); ?>-icon.svg">
                                    </a>
                                </li>
                            <?php endif; ?>
                        <?php endwhile; ?>
